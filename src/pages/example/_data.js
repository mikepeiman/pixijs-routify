...
// }
// let origin = ''
// let auth = axios.post(authUrl + clientId + scope + clientSecret)
// auth.then(res => {
//   console.log(`auth response ${res}`)
// })
// let response = axios.post('https://api.todoist.com/rest/v1/projects', token)
// axios.get("https://api.todoist.com/rest/v1/projects", token).then(data => {
//   console.log(`from _data.js, response `, data)
// })
// console.log(`from _data.js, response `, response)
// response.then(data => {
...
.get(todoistREST, {
  ...
  console.log(`trying again res ${res.data}`)
  let data = res.data
  for(let [key, val] of Object.entries(data)) {console.log(key, val)}
})
